...
export default function Login() {
  ...
  return (
    <View className="w-full h-screen bg-primaryColor items-center">
      ...
      <Text className="text-focusColor font-bold tracking-tight text-2xl uppercase mt-24">Iniciar sesión</Text>
      ...
      className="mt-9 border-focusColor border-[1px] rounded-sm bg-primaryColor p-2 w-36">              
        <Text className="text-contrastColor text-center uppercase font-semibold">Iniciar sesión</Text>
      </TouchableOpacity>
        <View className="bg-secondaryColor w-full rounded-md flex justify-center mt-32 h-14">
          <TouchableOpacity onPress={()=> navigation.navigate("Registrarse")}>
            <Text className="text-center text-contrastColor">Crear una cuenta</Text>
          </TouchableOpacity>
        </View>
    </View>
  )
